                ...
                <div id="content">
                    <div id="respond">
                        <form action="ForgotPassword" method="post">
                            <table>
                                <tr><td>Enter your registered Email Id:</td><td> <input type="text" name="emailid" id="emailId" value="" size="22" />
                                    </td>
                                <td>Email address not found </td>
                                </tr>
                                <tr><td><input name="submit" type="submit" id="submit" value="Next" /></td>
                                    <td> <input name="cancel" type="submit" onclick="form.action='index.html';" id="cancel" tabindex="5" value="Cancel" /></td></tr>
                            </table>                             
