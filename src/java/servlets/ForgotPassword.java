    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                RequestDispatcher view = request.getRequestDispatcher("/forgotpasswordnotfound.jsp");
                view.forward(request, response);
                
                
            }
            RequestDispatcher view = request.getRequestDispatcher("/forgotpassoword1.jsp");
            view.forward(request, response);
        }
    }
